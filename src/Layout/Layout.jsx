...
function Layout(props) {
    return (
        <>
            <header className='w-[100%] flex flex-col pb-6'>
                <div className='w-[100%] h-8 bg-stone-100'>
                    <div className="container flex items-center justify-between">
                        ...
                        <h5 className='text-[grey]' id='h5'>Доставим ваш заказ бесплатно всего за 1 день</h5>
                ...
                <div className="container flex flex-col">
                    <div className='pt-5 flex justify-between'>
                        ...
                        <div className='min-w-[20%] flex gap-3 items-center'>
                            ...
                            <div className='h10 rounded border-2 border-gray-300 flex items-center justify-between overflow-hidden' id='inp'>
                                ...
                                <button className='h-10 pl-5 pr-5 bg-gray-200 '>
                                    <img className='w-[100%] h-[100%]' src={logo} alt="" />
                                </button>
                            </div>
                        </div>
                        <div className="flex h5_3_1">

                            <span className='h5_3 flex items-center'>
                                <img src={profile} alt="" />
                                <h5 className=''>Войти</h5>
                            </span>
                            <span className='h5_3 flex items-center'>
                                <Link to="/favourite" className='flex items-center'>
                                    ...
                                    <h5 className=''>Избранное</h5>
                                </Link>
                            </span>
                            <span className='h5_3 flex items-center '>
                                <Link to="/basket" className='flex items-center'>
                                    <img src={basket} alt="" />
                                    <h5 className=''>Корзина</h5>
                                </Link>
                            </span>
                        </div>
                    ...
                    <div className='pt-5'>
                        <ul className='flex items-center justify-between text-[grey]'>
            ...
            <footer className='pt-20 w-[100%]'>
                <div className="container grid grid-cols-4 footer">
                    ...
                    <div className='div width w-[100%] flex flex-col gap-6 pb-12'>
                ...
                <div className="container w-[100%]">
                    <div>
                        ...
                        <div className='flex justify-between items-center pt-2 pb-2'>
                            ...
                            <h6 className='fon'>«2023© ООО «UZUM MARKET». ИНН 309376127. Все права защищены»</h6>
                        </div>
                    </div>
                </div>
            </footer>
